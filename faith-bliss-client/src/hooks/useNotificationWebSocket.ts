...
type NotificationWebSocketServiceInstance = InstanceType<
  typeof NotificationWebSocketServiceClass
>;
...
export function useNotificationWebSocket() {
  ...
  useEffect(() => {
    ...
    // Condition 2: User logs out (isAuthenticated is false) AND a service instance exists
      ...
      console.log(
        "User logged out, disconnecting Notification WebSocketService..."
      );
