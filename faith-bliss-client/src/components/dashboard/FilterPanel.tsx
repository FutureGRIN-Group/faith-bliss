    ...
    <div className="h-full flex flex-col">
      ...
      >
        ...
        <div className="bg-linear-to-br from-indigo-500/10 to-blue-500/10 rounded-2xl p-5 border border-indigo-500/20">
          <label className="block text-sm font-bold text-indigo-300 mb-3 uppercase tracking-wide">
            Gender
          </label>
          <select
            value={gender}
        ...
        <div className="bg-linear-to-br from-pink-500/10 to-purple-500/10 rounded-2xl p-5 border border-pink-500/20">
          <label className="block text-sm font-bold text-pink-300 mb-3 uppercase tracking-wide">
            Distance Range
          </label>
          <input
            type="range"
        ...
        <div className="bg-linear-to-br from-emerald-500/10 to-teal-500/10 rounded-2xl p-5 border border-emerald-500/20">
          <label className="block text-sm font-bold text-emerald-300 mb-3 uppercase tracking-wide">
            Faith Journey
          </label>
          <select
            value={faithJourney}
        ...
        <div className="bg-linear-to-br from-rose-500/10 to-pink-500/10 rounded-2xl p-5 border border-rose-500/20">
          <label className="block text-sm font-bold text-rose-300 mb-3 uppercase tracking-wide">
            Looking For
          </label>
          <select
