...
export const SidePanel = ({
  ...
  return (
    <Sidebar>
      <div className="h-screen flex flex-col gap-5 bg-gray-900 lg:bg-gray-800/50 lg:backdrop-blur-xs lg:border-r lg:border-gray-700/30">
        {/* Header */}
        <SidebarHeader className="shrink-0 p-6 border-b border-gray-700/50">
        ...
        <SidebarContent>
          {/* Main Navigation */}
          <div className="flex-1 min-h-0  space-y-2 overflow-y-auto side-panel-scroll">
            {/* Primary Navigation */}
            <SidebarGroup>
              <SidebarGroupLabel>
                <h5 className="text-gray-400 text-xs uppercase tracking-wider font-semibold mb-3 ">
                  Navigation
                </h5>
              </SidebarGroupLabel>
              <SidebarGroupContent>
            ...
            <div className="border-t border-gray-700/50 pt-4">
              <h5 className="text-gray-400 text-xs uppercase tracking-wider font-semibold mb-3 px-4">
                Profile
              </h5>
